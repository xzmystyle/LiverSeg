...
def remove_small_files(all_files, total_file_path, single_file_path, new_path_list):
    file_num = len(all_files)
    count = 0
    file_path = os.path.join(total_file_path, single_file_path)
...
if __name__ == '__main__':
    ...
    for file_path in file_paths:
        ...
        remove_small_files(all_files, total_file_path, file_path, new_path_list)
